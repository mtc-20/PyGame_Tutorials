...
meteor_list['md'] =[]
meteor_list['sm'] =[]
meteor_list['bg'] =['meteorBrown_big1.png']
meteor_list['md'] =['meteorBrown_med1.png', 'meteorBrown_med1.png','meteorBrown_med3.png']
meteor_list['sm'] =['meteorBrown_small1.png','meteorBrown_small2.png',
              'meteorBrown_tiny1.png']
for img in meteor_list['bg']:
    meteor_images['bg'].append(pygame.image.load("img/{}".format(img)).convert())
for img in meteor_list['md']:
    meteor_images['md'].append(pygame.image.load("img/{}".format(img)).convert())
for img in meteor_list['sm']:
    meteor_images['sm'].append(pygame.image.load("img/{}".format(img)).convert())
...
#        self.image = pygame.Surface((30,40))
        self.type = random.choice(['sm','md','bg'])
...
#set font
font_name = pygame.font.match_font('sawasdee')
...
def show_go_screen():
    ...
    draw_text(screen, "Retro Space Shooter!", 50, WIDTH/2, HEIGHT/4)
    draw_text(screen, "Arrows to move, SPACE to fire", 22, WIDTH/2, HEIGHT/2)
    draw_text(screen, "Press any key to continue...", 20, WIDTH/2, HEIGHT*3/4)
    pygame.display.flip()
    wait_for_key()
